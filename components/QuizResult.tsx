...
export function QuizResult({
  ...
  return (
    <div className="card card-pad max-w-lg mx-auto text-center p-8 sm:p-10 shadow-[var(--shadow-pop)]">
      {isPerfect ? (
        <div className="w-16 h-16 rounded-full bg-[var(--green-bg)] text-[var(--green)] flex items-center justify-center mx-auto mb-4">
          <CheckCircle2 className="w-9 h-9" />
        </div>
      ) : (
        <div className="w-16 h-16 rounded-full bg-[var(--blue-soft)] text-[var(--blue)] flex items-center justify-center mx-auto mb-4">
          <CheckCircle2 className="w-9 h-9" />
        </div>
      )}
      ...
      {/* Score Big Display */}
      <div className="my-8 p-6 rounded-[16px] bg-[var(--surface-2)] border border-[var(--line)]">
